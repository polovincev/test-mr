...
const TasksInner: React.FC<{ chatId?: number; topic?: string; navigate: any; location: any }> = ({ chatId, topic, navigate, location }) => {
  ...
  const loadingPhrases = [
    "Соединяю разные темы в одну...",
    "Ищу самые понятные объяснения...",
    "Перевожу сложное на простой язык...",
    "Собираю пазл из тем и правил...",
    "Готовлю короткий путь к ответу...",
    "Нахожу лайфхаки для запоминания...",
    "Отфильтровываю всё лишнее...",
    "Упаковываю сложное в простые шаги...",
    "Строю мосты между теорией и практикой...",
    "Подбираю задания, которые щёлкнутся...",
    "Продумываю план атаки на тему...",
    "Разбираю сложное на атомы...",
    "Загружаю только самую суть...",
    "Перемешиваю факты и практику...",
    "Включаю режим «Объясняю как другу»...",
